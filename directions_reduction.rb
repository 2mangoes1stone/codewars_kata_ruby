...
def dirReduc(arr)
  3.times do  
    arr.each_with_index do|v, i| 
        arr.slice!(i..i+1) if arr[i] == "NORTH" && arr[i + 1] == "SOUTH"
        arr.slice!(i..i+1) if arr[i] == "SOUTH" && arr[i + 1] == "NORTH"
        arr.slice!(i..i+1) if arr[i] == "EAST" && arr[i + 1] == "WEST"
        arr.slice!(i..i+1) if arr[i] == "WEST" && arr[i + 1] == "EAST"
    end
  end
  arr
end
